...
public class FrmMenuPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuItem4.setText("Secretarias");
        ...
        jMenuItem10.setText("Secretarias");
        ...
        jMenuItem13.setText("Reviciones");
        ...
        jMenuItem16.setText("Secretarias");
        ...
        jMenuItem18.setText("Reviciones");
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        FrmCrearUsuarios frmU = new FrmCrearUsuarios();
        escritorio2.add(frmU);
        frmU.show();
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        FrmCrearSecretaria frmS = new FrmCrearSecretaria();
        escritorio2.add(frmS);
        frmS.show();
    ...
    private void jMenuItem6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem6ActionPerformed
        FrmCrearReviciones frmR = new FrmCrearReviciones();
        escritorio2.add(frmR);
        frmR.show();
    ...
    private void jMenuItem8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem8ActionPerformed
        FrmCrearUsuarios frmM = new FrmCrearUsuarios();
        escritorio2.add(frmM);
        frmM.show();
    ...
    private void jMenuItem12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem12ActionPerformed
        FrmEliminarUsuario frm = new FrmEliminarUsuario();
        escritorio2.add(frm);
        frm.show();
    }//GEN-LAST:event_jMenuItem12ActionPerformed

    private void jMenuItem15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem15ActionPerformed
        FrmEliminarTecnico frm1 = new FrmEliminarTecnico();
        escritorio2.add(frm1);
        frm1.show();
    }//GEN-LAST:event_jMenuItem15ActionPerformed

    private void jMenuItem16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem16ActionPerformed
        FrmEliminarSecretaria frm1 = new FrmEliminarSecretaria();
        escritorio2.add(frm1);
        frm1.show();
    ...
    private void jMenuItem17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem17ActionPerformed
        FrmEliminarCita frmC = new FrmEliminarCita();
        escritorio2.add(frmC);
        frmC.show();
    }//GEN-LAST:event_jMenuItem17ActionPerformed

    private void jMenuItem18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem18ActionPerformed
         FrmEliminarRevicion frmC = new FrmEliminarRevicion();
        escritorio2.add(frmC);
        frmC.show();
    ...
    private void jMenuItem22ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem22ActionPerformed
       FrmConfiguracionConexion f=new FrmConfiguracionConexion();
       escritorio2.add(f);
       f.show();
